...
const mockCases: Case[] = [
  {
    ...
    items: [
      ...
      { id: 3, name: 'Token', price: 5.50, image: ASSET_PATHS.IMAGES.TOKEN, rarity: 'common' },
      { id: 4, name: 'Gold Token', price: 15.75, image: ASSET_PATHS.IMAGES.TOKEN_GOLD, rarity: 'rare' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 5, name: 'Token', price: 5.50, image: ASSET_PATHS.IMAGES.TOKEN, rarity: 'common' },
      { id: 6, name: 'Gold Token', price: 15.75, image: ASSET_PATHS.IMAGES.TOKEN_GOLD, rarity: 'rare' },
  ...
  },
  {
    ...
    items: [
      { id: 1, name: 'Teddy Bear', price: 10.91, image: ASSET_PATHS.IMAGES.TEDDY, rarity: 'common' },
      { id: 2, name: 'Token', price: 5.50, image: ASSET_PATHS.IMAGES.TOKEN, rarity: 'common' },
      { id: 3, name: 'Gold Token', price: 15.75, image: ASSET_PATHS.IMAGES.TOKEN_GOLD, rarity: 'rare' },
